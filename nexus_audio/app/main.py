...
class Worker:
    ...
    def _start_spotify(self):
        ...
        cmd=['librespot','--name',self.cfg['name'],'--device-type',self.cfg.get('spotify_device_type','speaker'),
