...
> Version actuelle : **1.0.0-rc1** — candidate de validation terrain. Les moteurs sont intégrés, mais la chaîne Dante/PTP et les appareils réels doivent encore être validés sur l'installation cible avant de qualifier cette version de stable.
...
**1.0.0-rc1** freezes the feature set around AirPlay, Spotify Connect, Dante RX and AES67. The remaining step before a stable `1.0.0` is real-hardware acceptance testing on the target Home Assistant OS / Music Assistant / Dante network.

---

**License : Apache-2.0
Copyright © 2026 Cyprien De Waele — Nexus Audio / Mct**
